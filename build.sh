      ...
      <section class=\"conflict-cta\">
        <div class=\"cta-card\">
          ...
          <div style=\"display:flex;gap:0.75rem;justify-content:center;flex-wrap:wrap;margin-top:1rem;\">
            <a href=\"$PLAY_STORE\" target=\"_blank\" rel=\"noopener\" class=\"btn-primary\" style=\"display:inline-flex;align-items:center;gap:0.5rem;\">
            ...
            <a href=\"$APP_STORE\" target=\"_blank\" rel=\"noopener\" class=\"btn-primary\" style=\"display:inline-flex;align-items:center;gap:0.5rem;\">
