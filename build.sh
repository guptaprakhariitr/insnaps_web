    ...
    <div class="container">
      ...
      <div class="blog-coming-soon">
        <div class="cta-card">
          ...
          <p style="margin-top:1rem;color:var(--fg-muted);font-size:0.9rem;">In the meantime, follow us on <a href="https://www.reddit.com/r/InSnapsNewsUpdates/" target="_blank" rel="noopener">Reddit</a> and <a href="https://x.com/BuildWtPrakhar" target="_blank" rel="noopener">X (Twitter)</a> for updates.</p>
        </div>
      </div>
    </div>
  </main>
